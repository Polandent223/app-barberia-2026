import {cloudBootstrapPlatform,uploadBusinessCatalog,downloadBusinessCatalog,uploadCurrentTenant,uploadTenantState,ensureTenantState,downloadTenant,watchCatalog,watchCurrentTenant,stopSaaSCloud} from "./saas-cloud.js?v=1.0.18";
...
function refreshHydrationUI(){const id=currentBusinessId(),role=String(SaaS.session?.role||"");setHydrationUI(role!=="superadmin"&&!!id&&tenantHydrating(id),id)}
