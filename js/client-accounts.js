/* SAMBRIX · Cuenta del cliente, sesión local de compatibilidad y prevención de duplicados */
(function(){
 ...
 // Compatibilidad local para entornos sin cuenta cloud; producción usa Firebase Auth.
