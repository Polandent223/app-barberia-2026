...
App.saveAppointment = function(){
  ...
  if(App.appointmentConflict(d))return App.toast(`Ese ${App.businessVocabulary?.().staffOne||"profesional"} no está disponible durante todo el servicio`);
