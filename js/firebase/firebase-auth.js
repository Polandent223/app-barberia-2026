import {auth,onAuthStateChanged,signInWithEmailAndPassword,createUserWithEmailAndPassword,signOut,sendPasswordResetEmail} from "./firebase-core.js";
...
export async function firebaseSendPasswordReset(email){await sendPasswordResetEmail(auth,String(email||"").trim());return true}
