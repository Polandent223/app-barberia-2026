/* SAMBRIX · Confirmación administrativa de reservas del cliente */
(function(){
  ...
  A.confirmAppointment2032=function(id){
    if(!canSchedule())return A.toast('No tienes permiso para confirmar citas');
  ...
  A.rejectAppointment2032=function(id){
    if(!canSchedule())return A.toast('No tienes permiso para rechazar citas');
    const a=A.db.appointments.find(x=>x.id===id);if(!a||a.status!=='Pendiente')return;
